...
sed -i 's/password_here/lee3861421/g' /var/www/html/wp-config.php
sed -i 's/localhost/mydb.cw36mpqdrx6x.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
#sed -i 's/localhost/mydb.cqep7uwq9udb.ap-northeast-1.rds.amazonaws.com/g' /var/www/html/wp-config.php
cat > /var/www/html/health.html << EOF
<html><body><h1>HGSHIN WEB SERVER _ health </h1></body></html>
EOF
